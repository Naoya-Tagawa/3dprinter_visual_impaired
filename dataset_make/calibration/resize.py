...
images = glob.glob('./dataset_make/calibration/*.jpg')
for filepath in images:
    ...
    cv2.imwrite('././dataset_make/calibration/img_drawChessboardCorners/' + str(os.path.basename(filepath)), img)
    cv2.waitKey(0)
...
for filepath in images:
    ...
    cv2.imwrite('./dataset_make/calibration/img_undistort/undistort_' + str(os.path.basename(filepath)), dst)
    cv2.waitKey(0)