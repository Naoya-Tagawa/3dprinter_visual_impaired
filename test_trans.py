...
from img_processing2 import cut_blue_trans,arrow_exist,mask_make, match_text3,projective_transformation,points_extract1,cut_blue_img1,Projection_H,Projection_V,Detect_HeightPosition,Detect_WidthPosition,match_text,match_text2,sabun,match,cut_blue_img2
import audio_output
...
img4 = cv2.imread("./hei/camera1188.jpg")
...
cv2.waitKey(0)
#射影変換
syaei_img,M = projective_transformation(img4,p1,p2,p3,p4)
