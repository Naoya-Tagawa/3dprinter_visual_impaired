...
def diff_image_search(mask_present_img2,frame_diff,present_char_List2,before_frame,before_frame_row1,before_frame_row2,before_frame_row3,before_frame_row4,output_text,img_temp,label_temp):
...
if __name__ == "__main__":
    ...
    while True:
        ...
        blue_threshold_present_img = cut_blue_img2(base1)
        #kk
        before_frame_row = []
        sabun_count = 0
        judge = False
        ...
        #cv2.imshow("realtimeimg.jpg",frame_diff)
        cv2.imshow("mask_frame.jpg",mask_present_img2) 
        before_frame_row1,before_frame_row2,before_frame_row3,before_frame_row4,before_frame= diff_image_search(mask_present_img2,frame_diff,present_char_List2,before_frame,before_frame_row1,before_frame_row2,before_frame_row3,before_frame_row4,output_text,img_temp,label_temp)
